...
function display(n) {
  ...
  s1.style = "background: #27df83; color: #FFF;";
  s2.style = "background: #27df83; color: #FFF;";
  s3.style = "background: #27df83; color: #FFF;";
  s4.style = "background: #27df83; color: #FFF;";

  if (n == 1) {
    img1.style = "display: block;";
    s1.style = "background: #E5E8EF; color: #27df83;";
  }
  if (n == 2) {
    img2.style = "display: block;";
    s2.style = "background: #E5E8EF; color: #27df83;";
  }
  if (n == 3) {
    img3.style = "display: block;";
    s3.style = "background: #E5E8EF; color: #27df83;";
  }
  if (n == 4) {
    img4.style = "display: block;";
    s4.style = "background: #E5E8EF; color: #27df83;";
  }
}
